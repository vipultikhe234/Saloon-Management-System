...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('saloon-admin.services.update', $service->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="gender" id="gender" class="form-control" required>
                            ...
                            <option value="unisex" {{ old('gender', $service->gender) == 'unisex' ? 'selected' : '' }}>Unisex</option>
                        </select>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="discounted_price" id="discounted_price" class="form-control" value="{{ old('discounted_price', $service->discounted_price) }}">
