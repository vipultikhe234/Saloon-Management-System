...
@section('title', 'Create Saloon Profile')
@section('page-title', 'Create Saloon Profile')
@section('page-subtitle', 'Setup your saloon details to get started')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('saloon-admin.saloon.store') }}" method="POST">
            @csrf
            ...
            <div class="flex items-center justify-end gap-4 mt-8 pt-4 border-t">
                <button type="submit" class="btn-primary">
                    <i class="fas fa-save mr-2"></i>Create Saloon Profile
                </button>
            </div>
        </form>
    </div>
