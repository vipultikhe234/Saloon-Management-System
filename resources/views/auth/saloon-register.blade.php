<x-guest-layout>
    <div class="mb-8 text-center">
        <h2 class="text-3xl font-bold text-gray-800">Register Your Saloon</h2>
        <p class="text-gray-600 mt-2">Join our platform and grow your business today.</p>
    </div>
    ...
    <form method="POST" action="{{ route('saloon.register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="email@saloon.com" />
